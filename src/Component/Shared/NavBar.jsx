...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <div className='navbar mb-8 container px-4 mx-auto z-10 bg-opacity-80 bg-gradient-to-r from-blue-600 via-purple-500 to-green-500  max-w-screen-xl rounded-lg'>
        <div className='flex-1'>
          <Link to='/' className='flex gap-2 items-center'>
            <img className='w-auto h-14 rounded-full bg-white' src={logo} alt='' />
            <span className='font-bold hover:bg-orange-100 rounded-lg active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-30 font-sans text-xl text-black'> <span className='text-blue-200'>CampAid</span> </span>
          </Link>
        </div>
